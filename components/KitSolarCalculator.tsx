...
const KWH_BY_DEPT: Record<string, number> = {
  Amazonas: 593, Antioquia: 472, Arauca: 562,
  Atlántico: 441, Bolívar: 514, Boyacá: 483,
  Caldas: 491, Caquetá: 633, Casanare: 552,
  Cauca: 523, Cesar: 497, Chocó: 678,
  Córdoba: 456, Cundinamarca: 470, "Distrito Capital": 470,
  Guainía: 716, Guaviare: 641, Huila: 482,
  "La Guajira": 457, Magdalena: 482, Meta: 492,
  Nariño: 499, "Norte de Santander": 488, Putumayo: 574,
  Quindío: 491, Risaralda: 492, Santander: 481,
  Sucre: 451, Tolima: 492, Valle: 479,
  Vaupés: 708, Vichada: 735,
};
      ...
      <CardBody className="space-y-6">
        ...
        <Select
          ...
          onSelectionChange={(keys) =>
            setDept(Array.from(keys)[0] as string)
          }
        ...
        {/* 4. Botón */}
        <Button color="primary" fullWidth onPress={handleCalc}>
